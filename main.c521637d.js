...
`,p=(0,c.default)(u)`
  ...
  padding-top: 40px;
  padding-bottom: 20px;
`;t.App=()=>(0,i.jsxs)(c.ThemeProvider,{theme:d.theme,children:[(0,i.jsx)(d.GlobalStyle,{}),(0,i.jsx)(a.StrictMode,{children:(0,i.jsxs)(s,{children:[(0,i.jsx)(u,{children:(0,i.jsx)("div",{children:"Typescript React Template"})}),(0,i.jsx)(p,{as:"footer",children:"licensed under the MIT license."})]})})]})},985:(e,t,o)=>{const r=o(527),n=o(478),l=o(665);o(380);const i=document.querySelector("#root")||document.body;i.children.length?(0,n.hydrateRoot)(i,(0,r.jsx)(l.App,{})):(0,n.createRoot)(i).render((0,r.jsx)(l.App,{}))},380:()=>{console.group("Build info"),console.log("Project:","typescript-react-template"),console.log("Build date:",new Date("2023-12-18T10:09:07.551Z").toLocaleString()),console.log("Environment:","production(ci)"),console.log("Version:","3b7b0ab"),console.log("Coverage:",`${document.location.href}coverage/lcov-report/index.html`),console.log("Bundle report:",`${document.location.href}report.html`),console.groupEnd()},309:(e,t,o)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.theme=t.GlobalStyle=void 0;const r=o(511);t.GlobalStyle=r.createGlobalStyle`
body {
